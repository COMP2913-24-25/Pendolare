...
docker stop Pendo.AdminService
docker rm -f Pendo.AdminService

#docker stop Pendo.AdminService.Tests
#docker rm -f Pendo.AdminService.Tests

printf "\e[32mCompleted\e[0m\n"

# build fastapi image
printf "\033[1m============================= Building Docker Deploy Image ============================\033[1m\n"
docker build -f Dockerfile.deploy -t pendo.adminservice.deploy.image .
...
docker run -d -p 8000:8000 --name Pendo.AdminService pendo.adminservice.deploy.image
